...
description: Rclone is a command line program for syncing files and directories between cloud providers. Start copying data using rclone with lakeFS.
parent: Integrations
nav_order: 10
has_children: false
...
{: .no_toc }
[Rclone](https://rclone.org/){:target="_blank"} is a command line program for syncing files and directories between cloud providers.
...
You will have to choose whether to use your environment for authentication (recommended)
...
This can be useful when trying to minimi`e the number of transactions
Rclone does if you know the bucket exists already.

It can also be required if the user you are using doesn't have bucket
